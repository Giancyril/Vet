...
- **Priority-Based Findings Filtering**: Automatically prioritizes blocking issues first, suggestions second, and nitpicks last, respecting repository-configured comment limits and severity thresholds.
...
│   ├── src/
│   │   ├── app/
│   │   │   ├── config/             # Repository settings page
│   │   │   ├── repos/              # Repository list view
│   │   │   ├── reviews/[id]/       # Review detail, health report & remediation view
...
| **Automated Test Suite** | **94 / 94 Passed** | Full unit and integration coverage across all subsystems |
